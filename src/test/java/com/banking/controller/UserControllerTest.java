...
public class UserControllerTest {
	...
	public void testRegisterUser() {
		...
		responseDto.setMessage(ApplicationConstants.REGISTER_SUCCESS_MESSAGE);
		...
		assertEquals(ApplicationConstants.REGISTER_SUCCESS_MESSAGE, response.getBody().getMessage());
	}

	@Test
	public void testRegisterUserForFailure() {
		responseDto.setStatus(ApplicationConstants.FAILURE);
		when(userService.registerUser(requestDto)).thenReturn(responseDto);
